...
- Part A: Introduction
    - [Lecture A](Contents/Material/Part_A/Lecture_A.html){target="_blank"}
    - [Practical A](Contents/Material/Part_A/Practical_A_walkthrough.html){target="_blank"}
    - [`notebook.R`](Contents/Material/Part_A/notebook.R){target="_blank"}
    - [`markdown.Rmd`](Contents/Material/Part_A/markdown.Rmd){target="_blank"}
- Part B: How is `R` organized?
    <!-- - [Lecture B](Contents/Material/Part_B/Lecture_B.html){target="_blank"} -->
    - [Lecture B](Contents/Material/Part_B/Lecture-B_november.html){target="_blank"}
    - [Practical B](Contents/Material/Part_B/Practical_B.html){target="_blank"}
    - [Practical B with solutions](Contents/Material/Part_B/Practical_B_walkthrough.html){target="_blank"}
    - [`boys.RData`](Contents/Material/Part_B/boys.RData)

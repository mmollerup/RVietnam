...
This dashboard covers the materials for the course introducing R. Course held in Vietnam, May XX - May XX, 2023.
...
Material adopted from Statistics Denmark and [Gerko Vink](https://github.com/gerkovink/R) and Statistics Denmark.
...
|:------------|:------------------------------------------------|
| *Day1*      |                                                 |
| XX.XX-XX.XX | Introduction to R and RStudio (A)               |
|             | *Break*                                         |
| XX.XX-XX.XX | How is R organized? (B)                         |                 
| *Day2*      |                                                 |
| XX.XX-XX.XX | Data manipulation (C)                           |
|             | *Break*                                         |     
| XX.XX-XX.XX | Analyzing data (D)                              |
|             |                                                 |
| *Day3*      |                                                 |
| XX.XX-XX.XX | Data visualization (E)                          |
|             | *Break*                                         |             
| XX.XX-XX.XX | Loops and functions (F)                         |
| *Day4*      |                                                 |
| XX.XX-XX.XX|  R Markdown, lecture (G)                         |
|             | *Break*                                         |
...
We look forward to see you all in Ho Chi Minh City,  
...
- Part A: Introduction
    ...
    - [Practical A](Contents/Part_A/Practical_A_walkthrough.html){target="_blank"}
    - [`notebook.R`](Contents/Part_A/notebook.R){target="_blank"}
    - [`markdown.Rmd`](Contents/Part_A/markdown.Rmd){target="_blank"}
- Part B: How is `R` organized?
    - [Lecture B](Contents/Part_B/Lecture-B_november.html){target="_blank"}
    ...
    - [`boys.RData`](Contents/Part_B/boys.RData)
...
<br>
See also [this `rmarkdown` cheat sheet](Contents/Part_A/rmarkdown_cheat_sheet.pdf).
...
- Part D: Analyzing data 
    ...
    - [Practical D](Contents/Part_D/Practical_D_november.html)
    - [Practical D with solutions](Contents/Part_D/Practical_D_walkthrough_november.html)
...
- Part E: Data visualization
    ...
    - [Practical E with base R](Contents/Part_E/Practical_E_webex.html){target="_blank"}
    - [Practical E with ggplot](Contents/Part_E/Practical_E_webex_ggplot.html){target="_blank"}
...
- Part F: Loops and functions
    ...
    - [New Lecture F](Contents/Part_F/Lecture_F_new.html){target="_blank"}
    - [New Practical F](Contents/Part_F/Practical_F_new.html){target="_blank"}
    - [New Practical F with solutions](Contents/Part_F/Practical_F_walkthrough_new.html){target="_blank"}
...
- Part G: R Markdown
    ...
    - [Ideas for practical](Contents/Part_G/Some_graphs.html){target="_blank"}
    - [`Some_graphs.Rmd`](Contents/Part_G/Some_graphs.Rmd) Corresponding Rmd file for the Ideas.

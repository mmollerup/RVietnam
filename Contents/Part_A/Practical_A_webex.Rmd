...
If we don't want to go to a subfolder, but instead go up the file hierarchy, we can use `saveRDS(en.vector, file="../")`. The path is still relative to our working directory.
`r unhide()`

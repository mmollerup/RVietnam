...
inline <- function(x = "") paste0("`` `r ", x, "` ``")   #Verbatim for inline r code
...
<img src="kableExtraFig.png" alt="HTML5 Icon" width = 25%>

<!-- Note kableExtra pakken virker ikke i kombi med R 4.3.0 og ioslides (kableExtra kan ikke læses. ) FOr tidligere  -->
<!-- version (4.2.2) kan kableExtra indlæses men producerer tabel uden horisontale skillelinjer. Derfor produceres tabellerne i seperat rmd-dokument (traditionel html-ikke ioslides). Der gemes det som png med kable_save(). -->
...
* https://solutions.posit.co/connections/db/best-practices/dashboards/#example
